...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val replyPendingIntent = PendingIntent.getBroadcast(this,30,actionIntent,PendingIntent.FLAG_MUTABLE)
        val pendingIntent = PendingIntent.getActivity(this, 10 , actionIntent, PendingIntent.FLAG_IMMUTABLE)
        ...
        val builder: NotificationCompat.Builder
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                val channel = NotificationChannel(
                    channelId,
                    channelName,
                    NotificationManager.IMPORTANCE_LOW //알림의 중요도
                )
...
/*                val uri: Uri =
        ...
        val intent = Intent(this,Activity::class.java)//class뒤에 .java를 추가하는 이유는 자바로 작성된 API를 코틀린에서 이용하기 때문
